...
app.controller('myCtrl', function($scope, $interval) {
    $scope.projects = [
        ...
        {'title':'Dukaans','descr':'An E-Commerce website where the customer can order products from nearby stores.','tags':['NodeJS','MongoDB','Angular','Web'],'shots':['shot15.jpg','shot16.jpg','shot17.jpg','shot18.jpg'],'extras':[''],'level':99},
