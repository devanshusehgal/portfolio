...
app.controller('myCtrl', function($scope, $interval) {
    $scope.projects = [
        ...
        {'title':'DevPad','descr':'Text editor with format options written in Java.','tags':['Windows','Java'],'shots':['shot12.jpg','shot13.jpg','shot14.jpg'],'extras':['https://drive.google.com/file/d/1_SKUkgOgiCUJIqOLJs9mKyfBK8gCDKVO/view'],'level':0},
        {'title':'Dukaans','descr':'An ecommerce website where the customer can order products from nearby stores.','tags':['NodeJS','MongoDB','Angular','Web'],'shots':['shot15.jpg','shot16.jpg','shot17.jpg','shot18.jpg'],'extras':[''],'level':99},
        {'title':'Notify','descr':'A realtime alert notification delivery system for schools and colleges.','tags':['NodeJS','MongoDB','Angular','Web'],'shots':['shot19.jpg','shot20.jpg','shot21.jpg','shot22.jpg','shot23.jpg'],'extras':[''],'level':100},
        ...
        {'title':'MIN Browser','descr':'A browser from Windows based on the super-fast Chromium engine.','tags':['Windows','C#'],'shots':['shot43.jpg','shot44.jpg'],'extras':['https://drive.google.com/open?id=1yeMR2STp5WOAPHTHotTdzAo3uTUe_4iM'],'level':98},
        ...
        {'title':'Pool Tool','descr':'A simple hack for the 8 Ball Pool android game.','tags':['Games','NodeJS'],'shots':['shot47.png'],'extras':['https://drive.google.com/open?id=1gN7047DxGlbtpk1YKMX11OvdstFv7RQ6'],'level':0},
        ...
        {'title':'Tappy Bird','descr':'A clone of the famous game Tappy Bird.','tags':['Games','Java','Android'],'shots':['shot58.jpg','shot59.jpg'],'extras':['https://drive.google.com/open?id=1SglG9dWjz7GItt0rN_tL-Euw5cgPjAw4'],'level':0},
